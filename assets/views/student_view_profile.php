...
if(isset($_SESSION['studentID'])) {
    ...
    $query = $query = "SELECT *  FROM student WHERE student_id = " . $_SESSION['studentID'];
    $con = get_db();
    $result = pg_query($con, $query);
    if (pg_num_rows($result) > 0) {
        while ($row = pg_fetch_array($result)) {
            $_SESSION['student_name'] = $row[1];
            $_SESSION['stu_middle_name'] = $row[2];
            $_SESSION['stud_last_name'] = $row[3];
            $_SESSION['stud_birthdate'] = $row[4];
            $_SESSION['stud_email'] = $row[5];
            $_SESSION['stud_tutoremail'] = $row[6];
            $_SESSION['stud_phone'] = $row[7];
            $_SESSION['stud_tutor_phone'] = $row[8];
        }
    }
}
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-8 col-xl-10 offset-xl-0">
                ...
                if(isset($_SESSION['username']) && $_SESSION['message'] == "You are logged in Teacher" )
                {
                    echo '<h2 class="headtitle"> Student Profile  </h2>';
                }
                else if (isset($_SESSION['username']) && $_SESSION['message'] == "You are logged in Admin" )
                {
                    echo '<h2 class="headtitle"> Student Profile  </h2>';
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                    <table class="table">
                        ...
                        <tr>
                            <td>Middle name:</td>
                            <td> <?php echo $_SESSION['stu_middle_name']; ?></td>
                        </tr>
                        <tr>
                            <td>last name:</td>
                            <td> <?php echo $_SESSION['stud_last_name']; ?></td>
                        </tr>
                        <tr>
                            <td>Birthdate:</td>
                            <td> <?php echo $_SESSION['stud_birthdate']; ?></td>
                        </tr>
                        <tr>
                            <td>Student Email:</td>
                            <td> <?php echo $_SESSION['stud_email']; ?></td>
                        </tr>
                        <tr>
                            <td>Tutor Email:</td>
                            <td> <?php echo $_SESSION['stud_tutoremail']; ?></td>
                        </tr>
                        <tr>
                            <td>Student Phone:</td>
                            <td> <?php echo $_SESSION['stud_phone']; ?></td>
                        </tr>
                        <tr>
                            <td>Tutor Phone:</td>
                            <td> <?php echo $_SESSION['stud_tutor_phone'];?></td>
                        </tr>
                    </table>
                    <br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="recipient-tutoremail" class="col-form-label">Zoom Office:</label>
                            <input type="url" class="form-control" id="recipient-tutoremail" disabled="disabled" name="recipient-tutoremail" value="<?php echo $_SESSION['stud_tutoremail']; ?>">
                            <!-- Checkbox to send to PSQL -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="recipient-stud-phone" disabled="disabled" name="recipient-stud-phone" value="<?php echo $_SESSION['stud_phone']; ?>">
                            <!-- Checkbox to send to PSQL -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="recipient-tutorphone" disabled="disabled" name="recipient-tutorphone" value="<?php echo $_SESSION['stud_tutor_phone']; ?>">
                            <!-- Checkbox to send to PSQL -->
