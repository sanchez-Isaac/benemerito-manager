...
if(isset($_POST['Submitting'])) {
    ...
    $_SESSION['add-stud-names'] = pg_escape_string($_POST['add-recipient-names']);
    $_SESSION['add-stud-middles'] = pg_escape_string($_POST['add-recipient-middles']);
    ...
    header("Location: uniqueEmailCheckStud.php?Approved=");
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <a style="text-align: left;padding: 0.375rem 2.75rem; width: 25%;"class="btn btn-primary btn-block" role="button" data-bs-toggle="button">Student</a>
